<p align="center">
  <b>eth-staking-tool</b>
</p>

<p align="center">
  <sub>validator · rewards · withdraw</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>EthStake</code> &nbsp;·&nbsp; <code>ethstake</code>
</p>
...
Ethereum staking dashboard — validator list, reward accrual, withdrawal queue view.

Post-merge stakers search eth-staking-tool monthly.
...
```bash
dotnet restore eth-staking-tool.slnx
dotnet build eth-staking-tool.slnx -c Release
dotnet test eth-staking-tool.slnx -c Release
```
