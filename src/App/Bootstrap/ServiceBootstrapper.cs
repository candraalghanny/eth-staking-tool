using EthStake.App.Commands;
using EthStake.ChainProviders.Evm;
using EthStake.ChainProviders.Transport;
using EthStake.ChainProviders.Utxo;
using EthStake.Cryptography.Derivation;
using EthStake.Cryptography.Vault;
using EthStake.Engine.Analytics;
using EthStake.Engine.Domain.Contracts;
using EthStake.Engine.Networks;
using EthStake.Engine.Options;
using EthStake.Engine.Orchestration;
using EthStake.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace EthStake.App.Bootstrap;
